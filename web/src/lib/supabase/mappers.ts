...
export function panelistRowToRecord(row: Record<string, unknown>): PanelistRow {
  ...
  return {
    ...
    org_district: metadataString(meta, "org_district"),
    org_description: metadataString(meta, "org_description"),
    org_size: metadataString(meta, "org_size"),
    org_ownership_structure: metadataString(meta, "org_ownership_structure"),
    org_ownership_structure_other: metadataString(meta, "org_ownership_structure_other"),
    org_year_started: metadataString(meta, "org_year_started"),
    org_contact_means: metadataString(meta, "org_contact_means"),
...
export function panelistRecordToRow(row: PanelistRow, id?: string): Record<string, unknown> {
  const metadata: JsonObject = {
    ...
    country_if_abroad_other: row.country_if_abroad_other ?? "",
    ...
    org_district: row.org_district ?? "",
    org_description: row.org_description ?? "",
    org_size: row.org_size ?? "",
    org_ownership_structure: row.org_ownership_structure ?? "",
    org_ownership_structure_other: row.org_ownership_structure_other ?? "",
