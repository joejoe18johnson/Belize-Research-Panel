    ...
    tables: [
      {
        ...
        rows: [
          ...
          { channel: "Email change approval", count: pendingEmailChanges, action: "Approve or deny in Notifications" },
          { channel: "Phone change approval", count: pendingPhoneChanges, action: "Approve or deny in Notifications" },
...
function buildApiIntegrations(): AdminModuleSnapshot {
  const routes = [
    { group: "Auth", route: "Panelist sign in", status: "Live" },
    { group: "Auth", route: "Panelist sign up", status: "Live" },
    { group: "Auth", route: "Session check", status: "Live" },
    { group: "Registration", route: "Panelist registration", status: "Live" },
    { group: "Registration", route: "Username uniqueness check", status: "Live" },
    { group: "Profile", route: "Profile view and updates", status: "Live" },
    { group: "Profile", route: "Email change request", status: "Live" },
    { group: "Profile", route: "Phone change request", status: "Live" },
    { group: "Rewards", route: "Reward redemption", status: "Live" },
    { group: "Rewards", route: "Points balance", status: "Live" },
    { group: "Notifications", route: "Panelist notifications", status: "Live" },
    { group: "Admin", route: "Staff sign in", status: "Live" },
    { group: "Admin", route: "Mark possible duplicates", status: "Live" },
    { group: "Admin", route: "Export panelists", status: "Live" },
    { group: "Admin", route: "Update panelist record", status: "Live" },
    { group: "Admin", route: "Approve or deny email change", status: "Live" },
    { group: "Admin", route: "Approve or deny phone change", status: "Live" },
    { group: "Account", route: "Delete account", status: "Live" },
  ...
  return {
    ...
    description: "Live capabilities for sign-in, registration, profile updates, rewards, and admin review, plus planned external connectors.",
    metrics: [
    ...
    tables: [
      {
        ...
        columns: [
          ...
          { key: "route", label: "Capability / integration" },
          { key: "status", label: "Status" },
        ],
        rows: routes,
      },
