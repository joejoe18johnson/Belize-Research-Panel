...
export function FormSection({
  ...
  return (
    <section
      id={id}
      className="scroll-mt-[calc(var(--brp-header-height,4.75rem)+var(--brp-progress-height,11rem)+1.25rem)] rounded-2xl border border-zinc-200 bg-white p-4 shadow-sm dark:border-zinc-800 dark:bg-zinc-900 sm:p-6"
    >
