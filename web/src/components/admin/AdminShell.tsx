  ...
  return (
    <div className="flex min-h-0 flex-1 flex-col bg-[linear-gradient(180deg,#f0fdfa_0%,#f4f4f5_10rem,#f4f4f5_100%)] dark:bg-[linear-gradient(180deg,#042f2e_0%,#09090b_10rem,#09090b_100%)]">
      <div className="flex min-h-0 flex-1 flex-col lg:flex-row lg:overflow-hidden">
        <aside className="safe-top z-40 flex shrink-0 flex-col border-b border-teal-100 dark:border-teal-900/60 bg-teal-950 text-white lg:h-full lg:w-72 lg:border-b-0 lg:border-r">
        ...
        <div className="flex min-h-0 min-w-0 flex-1 flex-col lg:overflow-hidden">
          <header className="shrink-0 border-b border-teal-100 dark:border-teal-900/60 bg-white/90 px-4 py-4 backdrop-blur-sm dark:border-teal-900/50 dark:bg-zinc-900/90 sm:px-6">
