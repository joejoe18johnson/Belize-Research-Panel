          ...
          <div className="space-y-5 p-6">
            <div>
              <div className="mb-2 flex items-center justify-between gap-2 text-xs font-medium">
                <span className="text-zinc-600">{formatHeadingCase("Progress to first redemption")}</span>
            ...
            <ul className="space-y-3 border-t border-zinc-100 pt-5 text-sm">
              ...
              <li className="flex items-center justify-between gap-4 text-zinc-700">
                ...
                <span className="font-semibold text-teal-800">+{rewards.registrationPoints}</span>
              </li>
              <li className="flex items-center justify-between gap-4 text-zinc-700">
          ...
          <ul className="mt-4 space-y-2.5 text-sm text-zinc-700">
            {REWARD_RULES.map((rule) => (
              ...
              >
                ...
                <span className="shrink-0 font-medium text-zinc-900">{rule.points}</span>
              </li>
            ))}
          </ul>
        </DashboardCard>
