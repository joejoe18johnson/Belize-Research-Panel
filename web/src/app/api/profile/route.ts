...
function parseProfileUpdateBody(body: unknown): ProfileUpdateFormData | null {
  ...
  return {
    ...
    addressHouseNumber: String(data.addressHouseNumber ?? ""),
    addressCityVillage: String(data.addressCityVillage ?? ""),
    addressCityVillageOther: String(data.addressCityVillageOther ?? ""),
    ...
    countryIfAbroadOther: String(data.countryIfAbroadOther ?? ""),
